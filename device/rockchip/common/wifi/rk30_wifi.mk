PRODUCT_COPY_FILES += \
	device/rockchip/common/wifi/lib/modules_smp/wlan.ko.3.0.8+:system/lib/modules/wlan.ko.3.0.8+ \
	device/rockchip/common/wifi/lib/modules_smp/wlan.ko:system/lib/modules/wlan.ko \
	device/rockchip/common/wifi/lib/modules_smp/rkwifi.ko.3.0.8+:system/lib/modules/rkwifi.ko.3.0.8+ \
	...
	device/rockchip/common/wifi/lib/modules_smp/8188eu.ko.3.0.8+:system/lib/modules/8188eu.ko.3.0.8+ \
	device/rockchip/common/wifi/lib/modules_smp/8192cu.ko:system/lib/modules/8192cu.ko \
	device/rockchip/common/wifi/lib/modules_smp/8192cu.ko.3.0.8+:system/lib/modules/8192cu.ko.3.0.8+ \
	device/rockchip/common/wifi/lib/modules_smp/rt5370sta.ko:system/lib/modules/rt5370sta.ko \
	device/rockchip/common/wifi/lib/modules_smp/rt5370sta.ko.3.0.8+:system/lib/modules/rt5370sta.ko.3.0.8+ \
	device/rockchip/common/wifi/lib/modules_smp/rt5370ap.ko:system/lib/modules/rt5370ap.ko \
	device/rockchip/common/wifi/lib/modules_smp/rt5370ap.ko.3.0.8+:system/lib/modules/rt5370ap.ko.3.0.8+ \
